...
public class MessageLabel {
    ...
    // Messages default
    public static final String MSG_DEFAULT_LABEL_NOT_FOUND = "msg.default.label_not_found";
    ...
    public static final String MSG_AUTHENTICATION_ACCOUNT_IN_ACTIVE = "msg.authentication.account_in_active";
